...
import { buildMovimentacaoXlsx, SYNTHETIC_CPF } from '@/adapters/ingestion/xlsx/test-support/builder';
...
const { handleImportCommit, handleImportStage, saveUploadedFile } = await import(
  '@/worker/handlers/import'
);
